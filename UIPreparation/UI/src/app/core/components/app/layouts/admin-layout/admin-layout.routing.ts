...
import { EntityExampleComponent } from 'app/modules/entityExample/entityExample.component';
...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'entityExample',  component: EntityExampleComponent,canActivate:[LoginGuard]}
